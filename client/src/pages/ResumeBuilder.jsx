...
const ResumeBuilder = () => {
  ...
  const loadExistingResume = async () => {
   try {
    ...
    setError("Failed to load resume. Please check your connection or try again later.");
  ...
  const handleShare = () =>{
    ...
    const resumeUrl = frontendUrl + '/app/preview/' + resumeId;
...
const saveResume = async () => {
  ...
  return (
    <div>
      {error && (
        <div className="max-w-2xl mx-auto my-8 p-4 bg-red-100 text-red-700 rounded text-center font-semibold">
          {error}
        </div>
      )}
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <button onClick={()=> {toast.promise(saveResume(), {loading: 'Saving...', success: 'Resume saved!', error: 'Failed to save'})}} className='bg-gradient-to-br from-blue-100 to-blue-200 ring-blue-300 text-blue-600 ring hover:ring-blue-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                Save Changes
              </button>
            </div>
          </div>
